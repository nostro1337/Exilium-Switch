---
name: quality-gate
description: Пошаговый пайплайн валидации (Zero-Regression): impact-анализ, послойная реализация, прогон тестов (>=80% coverage), tsc build и синхронизация графа знаний.
---

# Quality Gate & Release Verification Workflow

Используйте данный воркфлоу (`/quality-gate`) при разработке любых новых функций, устранении багов, рефакторинге или подготовке к коммиту/релизу.
